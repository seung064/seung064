...
<div align="left"> 
  ...
  <p>👨‍🔧 기계공학 전공자로, 플랜트·자동차·스마트팩토리 등 다양한 산업을 경험했습니다.</p>
  <p>🏭 생산 자동화와 공정 최적화에 관심이 많으며, 효율성과 안전을 높이는 기술에 집중해왔습니다.</p>
  <p>💻 최근엔 포스코 스마트팩토리 부트캠프를 통해 **데이터 기반 문제 해결과 프로그래밍 역량**을 키웠습니다.</p>
  <p>🔍 복잡한 문제에서 구조를 찾고, **현실적인 해결책을 제시하는 데 강점**이 있습니다.</p>
</div>
...
<div align="left">
  ...
  ### 2. 점진성형기술을 활용한 다양한 박판부품 개발에 대한 연구
  ...
  ### 3. 미니프로젝트 Window 계산기
  > Winforms을 통해 개발한 Window 계산기 프로젝트
  - **개발 기간:** 2025.05.02 ~ 2025.05.05
  - **기술 스택:** `C#`, `Winforms`
  - **Links:**
    - [GitHub Repository](https://github.com/seung064/CalculatorApp)
  
  ---

  ### 4. 미니게임
  > 게임 형식의 생산 공정 시뮬레이션을 기획하고, 소켓 통신과 생산 로직 기반 시스템을 구현한 중간 프로젝트
  - **개발 기간:** 2025.05.26 ~ 2025.06.09
